...
{
    public override Task<GrpcDependencies.Protos.UpsertDeviceResponse> UpsertDeviceStatus
        (GrpcDependencies.Protos.DeviceDetails request, ServerCallContext context)
    {
