...
public class GreeterService : Greeter.GreeterBase
{
    ...
    {        
        ...
        {
            Console.WriteLine($"Extracted the following integervalue from the payload: {request.Payload.Unpack<IntegerPayload>().Value}" );
            Console.WriteLine($"Extracted the following integervalue from the additional payload: {Convert.ToInt32(request.AdditionalPayload.NumberValue)}"); 
